...
export const REGRESSION_COVERAGE_MATRIX: readonly RegressionCoverageCase[] = [
  ...
  },
  {
    ...
    purpose: "Contrastar que el motor no aplica reglas DA 33.ª al suministro ordinario y no arrastra prórrogas o modificaciones inexistentes.",
    source: {
      expediente: "CONTR 2025 0000466864",
      shortName: "Panda Antivirus - AVRA",
      documents: ["MEMORIA", "PCAP", "PPT"],
      legalValidation: "PENDING",
      notes: "Documentación primaria incorporada a fuentes. Clasificación funcional preliminar pendiente de auditoría jurídica propia.",
    },
    tags: ["SIN_DA33", "SIN_LOTES", "PRECIO_100", "CASO_PRIORITARIO"],
  },
  {
    id: "REG-SUPPLY-003",
    ...
    source: {
      ...
      documents: ["MEMORIA", "PCAP", "PPT"],
      legalValidation: "PENDING",
      notes: "Fuentes incorporadas con memoria complementaria. Los hechos extraídos son de cobertura y no constituyen todavía una línea base jurídica validada.",
    },
  ...
  },
  {
    ...
    source: {
      ...
      documents: ["MEMORIA", "PCAP", "PPT", "ANEXOS"],
      legalValidation: "PENDING",
      notes: "Caso avanzado. El carácter de acuerdo marco y los criterios deben validarse de forma independiente antes de convertirlo en referencia de regresión jurídica.",
    },
  ...
  },
  {
    ...
    source: {
      ...
      documents: ["MEMORIA", "PCAP", "PPT"],
      legalValidation: "PENDING",
      notes: "Documentación primaria disponible. Debe auditarse expresamente la calificación del objeto y el tratamiento del componente de plataforma.",
    },
  ...
  },
  {
    ...
    source: {
      ...
      documents: ["MEMORIA", "PCAP", "PPT", "INFORME"],
      legalValidation: "PENDING",
      notes: "Caso redundante de control. Se conserva para detectar regresiones que pudieran pasar inadvertidas en un único suministro ordinario.",
    },

...
export function buildCanonicalDocumentContext(
  ...
  const context: DocumentContext = {
    ...
    thresholds: {
      justification: "El expediente canónico todavía no contiene un resultado autónomo del motor de umbrales; no se infiere silenciosamente.",
    },
    cpv: {
    ...
    deadlines: {
      justification: "El expediente canónico todavía no contiene un resultado autónomo del motor de plazos; no se infiere silenciosamente.",
    },
    lots: {
    ...
    generatedAt,
    version: "CANONICAL-DOCUMENT-CONTEXT-12.6-v1",
    language: "es-ES",
  };
  ...
  warnings.push("Umbrales y plazos siguen pendientes de integración canónica específica; no se han deducido a partir de otros campos.");

...
const KNOWN_UNIVERSAL_FIELDS = new Set([
  ...
  "economic.legalEstimatedValueCents", "administrative.contractingAuthority", "administrative.promotingUnit",
  "administrative.competentBody", "administrative.administrativeFileNumber", "administrative.contractManager",
  "technical.technicalPurpose", "technical.technicalRequirements", "technical.executionLocations",
  "technical.subrogationRequired", "technical.subrogationRegime", "lots.divisionIntoLots", "lots.lots",
  "lots.maxOfferableLots", "lots.maxAwardableLots", "guarantees.provisionalGuaranteeRequired",
  ...
  "execution.receiptAndAcceptanceRegime", "criteria.awardCriteria", "criteria.economicSolvency",
  "criteria.technicalSolvency", "criteria.judgmentCriteriaExist",
]);

...
function institutionalizeServiceEvidenceOdt(sourceBytes:Uint8Array,label:string,kind:"MEMORIA"|"PPT"):Uint8Array{
 ...
 // En Memoria recomponemos líneas partidas de prosa. En PPT cada línea física
 // limpia es una unidad técnica útil y conservarla separada evita volver a
 // concentrar una fuente multipágina en menos de 35 párrafos.
...
/** PPT Service: materializa como párrafos las líneas técnicas ya presentes en la fuente física. */

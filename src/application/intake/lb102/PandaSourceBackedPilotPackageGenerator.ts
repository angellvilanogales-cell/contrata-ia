...
/** Panda V8 se entrega exclusivamente como expediente atómico PCAP+Memoria+PPT de un mismo snapshot. */
export async function generatePandaSourceBackedPilotPackage(input:{record:UniversalEvidenceRecord;templateStore:UniversalEditableTemplateBinaryStore}){
 try{
  if(input.record.caseId!=="CONTR 2025 466864")throw new Error("El renderer Panda source-backed V8 solo admite el caso de regresión CONTR 2025 466864.");

...
<style:style style:name="CI_Meta" style:family="paragraph"><style:paragraph-properties fo:text-align="left" fo:margin-bottom="0.10cm"/><style:text-properties style:font-name="Source Sans Pro" fo:font-family="Source Sans Pro" fo:font-size="10.5pt" fo:font-weight="normal"/></style:style>
<style:style style:name="CI_Body" style:family="paragraph"><style:paragraph-properties fo:text-align="justify" fo:line-height="115%" fo:margin-bottom="0.16cm"/><style:text-properties style:font-name="Source Sans Pro" fo:font-family="Source Sans Pro" fo:font-size="10.5pt" fo:font-weight="normal"/></style:style>
<style:style style:name="CI_Bullet" style:family="paragraph"><style:paragraph-properties fo:text-align="justify" fo:line-height="115%" fo:margin-left="0.60cm" fo:text-indent="-0.30cm" fo:margin-bottom="0.12cm"/><style:text-properties style:font-name="Source Sans Pro" fo:font-family="Source Sans Pro" fo:font-size="10.5pt" fo:font-weight="normal"/></style:style>`;

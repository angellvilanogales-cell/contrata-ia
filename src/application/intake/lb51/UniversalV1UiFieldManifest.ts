...
export const UNIVERSAL_V1_UI_FIELD_MANIFEST: readonly UniversalV1UiFieldDefinition[] = [
  ...
  { fieldPath: "administrative.contractManager", label: "Persona o unidad responsable del contrato", control: "TEXT", requiredForValidatedSupplyAsa: false, humanValidationRequired: true, help: "Dato de organización interna que debe confirmar la Administración; artículo 62 LCSP." },
  ...
  { fieldPath: "execution.subcontractingRegime", label: "Régimen general de subcontratación", control: "TEXTAREA", requiredForValidatedSupplyAsa: false, humanValidationRequired: true },
  ...
  { fieldPath: "execution.assignmentRegime", label: "Régimen de cesión contractual", control: "TEXTAREA", requiredForValidatedSupplyAsa: false, humanValidationRequired: true },

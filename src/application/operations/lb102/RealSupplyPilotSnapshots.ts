...
function record(caseId:string,sourceId:string,values:Record<string,unknown>):UniversalEvidenceRecord{return{caseId,updatedAt:"2026-08-29T00:00:00.000Z",fields:Object.fromEntries(Object.entries(values).map(([k,v])=>[k,validated(k,v,sourceId)]))};}
...
export const LB102_SUPPLY_FERRETERIA=record("CONTR/2026/240267","REG-SUPPLY-001",{
 ...
 "technical.executionLocations":["Instalaciones de los Servicios Centrales del Servicio Andaluz de Empleo y sus oficinas anexas en Sevilla"],"technical.technicalRequirements":"Catálogo cerrado de 98 referencias de ferretería; cantidades estimativas variables según necesidades reales; productos de primera calidad; no pueden incorporarse artículos ni precios unitarios nuevos.",
 ...
 baseTenderBudgetCents:1055244,"economic.initialVatAmountCents":221601,"economic.initialPblVatIncludedCents":1276845,"economic.legalEstimatedValueCents":2179315,
 "economic.needsBasedContractDa33":true,"economic.budgetCoversEntireContractLife":true,"economic.estimatedValueCalculationMethod":"Presupuesto máximo DA 33.ª para toda la vigencia, 18.160,96 € sin IVA, más modificación prevista máxima del 20 %, resultando 21.793,15 € sin IVA.","economic.priceDeterminationRegime":"Precios unitarios por referencia del catálogo validado de 98 artículos.","economic.priceRevisionRegime":"No procede.",
 ...
 durationMonths:24,extensionMonths:24,"execution.extensionStructure":"Prórroga 1: 12 meses; prórroga 2: 12 meses. Las prórrogas no incrementan automáticamente el presupuesto máximo DA 33.ª.","execution.extensionNoticeMonths":2,
 "execution.plannedModificationRegime":"CONTR-2026-240267:STABILITY-DOWN-20:DA33-UP-20:NO-NEW-ARTICLES-OR-PRICES","execution.specialExecutionConditions":["Cumplimiento de las condiciones especiales de ejecución declaradas en el PCAP del expediente."],"execution.receiptAndAcceptanceRegime":"Entrega conforme a las necesidades del SAE y recepción previa comprobación de conformidad; plazo de entrega de 5 días hábiles conforme al expediente.",

...
export const LB102_SOURCE_FIDELITY_POLICY:Readonly<Record<LB102PilotPackageId,{level:LB102SourceFidelityLevel;accredited:boolean;reason:string}>>={
 ...
 "service-huelva":{level:"DERIVED_STYLE_PENDING_COMPARISON",accredited:false,reason:"Las tres fuentes físicas primarias están localizadas: Memoria 13 páginas, PCAP 103 páginas y PPT 28 páginas. Service V2 sigue sin reproducir esa profundidad documental, por lo que la acreditación permanece bloqueada."},
 "service-5g":{level:"DERIVED_STYLE_PENDING_COMPARISON",accredited:false,reason:"PCAP 111 páginas y PPT 50 páginas están acreditados como fuentes primarias de regresión; solo se ha localizado una diligencia de aprobación de la Memoria, no la Memoria primaria completa independiente. Service V2 tampoco reproduce todavía la profundidad documental."},
};

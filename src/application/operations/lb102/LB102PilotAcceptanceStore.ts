...
/** Persistencia durable LB102 con integridad SHA y compare-and-swap para no perder actos humanos concurrentes. */
export class HttpLB102PilotAcceptanceStore implements LB102PilotAcceptanceStoreLike{
 ...
 public async evidence(){return evidenceOf((await this.read()).state);}
}

import {generateStrictServicePilotPackageV2} from "../../intake/lb102/StrictServicePilotPackageGeneratorV2";
...
export const LB102_PILOT_PACKAGE_CATALOG:readonly LB102PilotPackageDescriptor[]=[
 ...
 {id:"service-sevilla",caseId:"CONTR 2026 38892",family:"SERVICE",label:"Mantenimiento integral SAE Sevilla",profile:"SERVICE_SOURCE_STRUCTURAL_PILOT_LB102_V2"},
] as const;
...
export async function generateLB102PilotPackage(id:LB102PilotPackageId):Promise<GeneratedLB102PilotPackage>{
 ...
 try{
  ...
  const snapshot=id==="service-huelva"?LB102_SERVICE_HUELVA:LB102_SERVICE_SEVILLA;const out=await generateStrictServicePilotPackageV2({snapshot,templateStore:store});

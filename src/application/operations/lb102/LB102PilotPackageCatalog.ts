...
export async function generateLB102PilotPackage(id:LB102PilotPackageId):Promise<GeneratedLB102PilotPackage>{
 ...
 try{
  ...
  const snapshot=id==="service-huelva"?LB102_SERVICE_HUELVA:LB102_SERVICE_5G;const out=await generateStrictServicePilotPackageV2({snapshot,templateStore:store});

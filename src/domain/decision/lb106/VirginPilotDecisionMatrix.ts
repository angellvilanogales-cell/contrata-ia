...
export const LB106_VIRGIN_PILOT_DECISION_MATRIX: readonly Lb106DecisionMatrixEntry[] = [
  ...
  {id:"D02_OBJECT_NATURE_CPV",title:"Objeto, naturaleza y CPV",question:"¿Cuál es la prestación completa, su naturaleza contractual, el CPV principal, los complementarios y, cuando existan lotes, qué códigos corresponden a cada lote?",factPaths:["object","contractType","cpvMain"],proposalRule:"Proponer naturaleza, CPV principal y candidatos complementarios desde la prestación declarada, mostrando la inferencia para validación y permitiendo su asignación por lotes.",applicationRule:"Comprobar que el objeto es determinado, que los códigos cubren las prestaciones reales y que su distribución por lotes es coherente, sin fraccionamiento artificioso.",legalBasisIds:["LCSP-99.1","LCSP-99.2"],discardedAlternatives:[alt("Otro tipo contractual o CPV","Se mantiene como alternativa hasta contrastar la prestación principal; no se descarta por semejanza con otro expediente.","LCSP-99.1")],riskIfUnresolved:"Selección errónea de régimen, procedimiento, lotes o modelo PCAP.",destinations:{memorySectionIds:["OBJECT_NATURE_CPV"],pptSectionIds:["TECHNICAL_OBJECT_SCOPE"],pcapAuthorizedTargets:["ANNEX_I.OBJECT","ANNEX_I.CPV"]},consent},
  ...
  {id:"D20_DOCUMENT_APPROVAL",title:"Conclusión, coherencia documental y consentimiento final",question:"¿Confirma la persona responsable que los hechos, decisiones, fundamentos y tres documentos son coherentes y pueden elevarse para aprobación?",factPaths:["closure.finalConsentRecord"],proposalRule:"Generar una vista previa determinista con las huellas de PCAP, Memoria, PPT y paquete, y mostrar cualquier bloqueo; nunca convertir una prueba automática en aprobación.",applicationRule:"Exigir consentimiento final nominativo ligado a las huellas del snapshot, selección documental, tres documentos y ZIP; cualquier cambio posterior lo invalida.",legalBasisIds:["LCSP-116.3","LCSP-122.1","LCSP-124"],discardedAlternatives:[alt("Aprobación automática","La máquina no sustituye al órgano ni a la persona responsable.","LCSP-116.3"),alt("Consentimiento genérico sin huellas","No acredita qué decisiones y documentos fueron examinados.","LCSP-116.3")],riskIfUnresolved:"Documentos divergentes, aprobación sin trazabilidad o descarga de una versión distinta de la consentida.",destinations:{memorySectionIds:["CONCLUSION_PROPOSAL"],pptSectionIds:["TECHNICAL_DOCUMENTATION_ANNEXES"],pcapAuthorizedTargets:["PACKAGE.FINAL_HUMAN_CONSENT"]},consent},
] as const;

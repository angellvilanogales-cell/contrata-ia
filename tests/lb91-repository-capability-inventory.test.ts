...
describe("LB91.3/11 - inventario antes de crear motores", () => {
  ...
  it("cierra el inventario de componentes universales sin afirmar todavía cobertura documental universal", () => {
    expect(getMissingUniversalCapabilities()).toEqual([]);
    expect(getCapabilityInventory("CROSS_DOCUMENT_AUDIT").universalComponent).toBeUndefined();
  });
});

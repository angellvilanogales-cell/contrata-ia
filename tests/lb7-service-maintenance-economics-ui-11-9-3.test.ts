...
describe("Paso 11.9.3 - interfaz de evidencia económica mantenimiento", () => {
  it("compila el script completo y preserva el alcance económico declarado", () => {
    ...
    expect(SERVICE_REGRESSION_MAINTENANCE_007_ECONOMICS_SCRIPT).toContain("182399114");
    expect(SERVICE_REGRESSION_MAINTENANCE_007_ECONOMICS_SCRIPT).toContain("82908688");
    expect(SERVICE_REGRESSION_MAINTENANCE_007_ECONOMICS_SCRIPT).toContain("16581738");
    expect(SERVICE_REGRESSION_MAINTENANCE_007_ECONOMICS_SCRIPT).toContain("100319513");
  ...
  it("mantiene visibles los redondeos y los campos jurídicos abiertos", () => {
    ...
    expect(SERVICE_REGRESSION_MAINTENANCE_007_ECONOMICS_SCRIPT).toContain("lotSumMinusDeclaredGlobalCents\":2");

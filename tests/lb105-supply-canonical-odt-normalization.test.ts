...
function fixture(): Uint8Array {
  return writeOdtZip([
    ...
    entry("styles.xml", '<office:document-styles xmlns:office="urn:o" xmlns:style="urn:s" xmlns:fo="urn:f" xmlns:text="urn:t" xmlns:draw="urn:d" xmlns:xlink="urn:x"><office:styles/><office:automatic-styles><style:page-layout style:name="pm"><style:page-layout-properties fo:page-width="20cm" fo:page-height="20cm"><style:footnote-sep/></style:page-layout-properties></style:page-layout></office:automatic-styles><office:master-styles><style:master-page style:name="M"><style:header><text:p><draw:frame><draw:image xlink:href="Pictures/logo.png"/></draw:frame></text:p></style:header><style:footer><text:p><text:page-number/></text:p></style:footer></style:master-page></office:master-styles></office:document-styles>'),
  ]);
}
